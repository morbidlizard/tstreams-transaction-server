...
CMD java -Dconfig=/etc/conf/config.properties -classpath tstreams-transaction-server-${version}.jar:slf4j-simple-1.7.24.jar:slf4j-api-1.7.24.jar:slf4j-log4j12-1.7.24.jar com.bwsw.tstreamstransactionserver.ServerLauncher
