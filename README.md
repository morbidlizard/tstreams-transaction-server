...
| transaction-database.transaction-keeptime-min | The time a producer transaction live after if it transits to one of final state: Checkpointed, Invalid.(default: 6 months). If negative integer - transaction lives forever. |int    | 50| |      
