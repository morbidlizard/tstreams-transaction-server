...
| transaction-database.transaction-keeptime-min | the lifetime of a producer transaction after persistence to database.(default: 6 months). If negative integer - transaction lives forever. |int    | 50| |      
