...
import com.bwsw.netty.server.{Authenticable, CheckpointTTL}
import transactionService.rpc.StreamService
import com.bwsw.exception.Throwables._
import org.apache.log4j.PropertyConfigurator
import org.slf4j.LoggerFactory
import com.bwsw.shared.FNV
import com.bwsw.utils.FileUtils
...
trait StreamServiceImpl extends StreamService[ScalaFuture]
  ...
  private val logger = LoggerFactory.getLogger(classOf[com.bwsw.netty.server.Server])
  ...
  override def getStreamDatabaseObject(stream: String): com.bwsw.netty.server.streamService.KeyStream =
