...
class ServerBuilder private(authOpts: AuthOptions, zookeeperOpts: ZookeeperOptions, bootstrapOpts: BootstrapOptions,
  ...
  def this() = this(AuthOptions(), ZookeeperOptions(), BootstrapOptions(), StorageOptions(),
    ServerReplicationOptions(), RocksStorageOptions(), PackageTransmissionOptions())

  def withAuthOptions(authOptions: AuthOptions) =
    new ServerBuilder(authOptions, zookeeperOptions, bootstrapOptions, storageOptions, serverReplicationOptions, rocksStorageOptions, packageTransmissionOptions)
  ...
  def withServerStorageOptions(serverStorageOptions: StorageOptions) =
    new ServerBuilder(authOptions, zookeeperOptions, bootstrapOptions, serverStorageOptions, serverReplicationOptions, rocksStorageOptions, packageTransmissionOptions)
  ...
  def withServerRocksStorageOptions(serverStorageRocksOptions: RocksStorageOptions) =
    new ServerBuilder(authOptions, zookeeperOptions, bootstrapOptions, storageOptions, serverReplicationOptions, serverStorageRocksOptions, packageTransmissionOptions)
  ...
  def build() = new Server(authOptions, zookeeperOptions, bootstrapOptions,
    storageOptions, serverReplicationOptions, rocksStorageOptions, packageTransmissionOptions)
