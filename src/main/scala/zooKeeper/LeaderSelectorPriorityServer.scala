...
//
//  private val logger = LoggerFactory.getLogger(classOf[LeaderSelectorPriority])
//
...
//        case _: IllegalMonitorStateException => logger.info("Need to update zookeeper client version to 2.11.1")
//        case _: java.lang.IllegalStateException => logger.info("Client connection is already closed")
//        case error => logger.error("Some error", error)
//      }
//    }
//  }
//}
