...
object ConsumerTxn extends ThriftStructCodec3[ConsumerTxn] {
  private val NoPassthroughFields = immutable$Map.empty[Short, TFieldBlob]
  val Struct = new TStruct("ConsumerTxn")
   ...
   */
  def validate(_item: ConsumerTxn): Unit = {
  ...
  def withoutPassthroughFields(original: ConsumerTxn): ConsumerTxn =
    new Immutable(
      stream =
        {
  ...
  override def encode(_item: ConsumerTxn, _oproto: TProtocol): Unit = {
    _item.write(_oproto)
  }

  private[this] def lazyDecode(_iprot: LazyTProtocol): ConsumerTxn = {
    ...
    if (!_got_stream) throw new TProtocolException("Required field 'stream' was not found in serialized data for struct ConsumerTxn")
    if (!_got_partition) throw new TProtocolException("Required field 'partition' was not found in serialized data for struct ConsumerTxn")
    if (!_got_transactionID) throw new TProtocolException("Required field 'transactionID' was not found in serialized data for struct ConsumerTxn")
    if (!_got_name) throw new TProtocolException("Required field 'name' was not found in serialized data for struct ConsumerTxn")
    new LazyImmutable(
      _iprot,
      _iprot.buffer,
      _start_offset,
  ...
  override def decode(_iprot: TProtocol): ConsumerTxn =
    _iprot match {
      case i: LazyTProtocol => lazyDecode(i)
      case i => eagerDecode(i)
    }

  private[this] def eagerDecode(_iprot: TProtocol): ConsumerTxn = {
  ...
  def unapply(_item: ConsumerTxn): _root_.scala.Option[scala.Product4[String, Int, Long, String]] = _root_.scala.Some(_item)
  ...
  object Immutable extends ThriftStructCodec3[ConsumerTxn] {
    override def encode(_item: ConsumerTxn, _oproto: TProtocol): Unit = { _item.write(_oproto) }
    override def decode(_iprot: TProtocol): ConsumerTxn = ConsumerTxn.decode(_iprot)
    override lazy val metaData: ThriftStructMetaData[ConsumerTxn] = ConsumerTxn.metaData
  }

  /**
   * The default read-only implementation of ConsumerTxn.  You typically should not need to
   * directly reference this class; instead, use the ConsumerTxn.apply method to construct
   * new instances.
   */
  class Immutable(
      val stream: String,
  ...
  /**
   * This Proxy trait allows you to extend the ConsumerTxn trait with additional state or
   * behavior and implement the read-only methods from ConsumerTxn using an underlying
   * instance.
   */
  trait Proxy extends ConsumerTxn {
    protected def _underlying_ConsumerTxn: ConsumerTxn
    override def stream: String = _underlying_ConsumerTxn.stream
    override def partition: Int = _underlying_ConsumerTxn.partition
    override def transactionID: Long = _underlying_ConsumerTxn.transactionID
    override def name: String = _underlying_ConsumerTxn.name
    override def _passthroughFields = _underlying_ConsumerTxn._passthroughFields
  }
}

trait ConsumerTxn
  extends ThriftStruct
  with scala.Product4[String, Int, Long, String]
  with HasThriftStructCodec3[ConsumerTxn]
  with java.io.Serializable
{
  import ConsumerTxn._
          ...
          _fieldId match {
            case 1 =>
              if (stream ne null) {
                ...
                _root_.scala.Some(ConsumerTxn.StreamField)
              } else {
                _root_.scala.None
              }
            case 2 =>
              if (true) {
                ...
                _root_.scala.Some(ConsumerTxn.PartitionField)
              } else {
                _root_.scala.None
              }
            case 3 =>
              if (true) {
                ...
                _root_.scala.Some(ConsumerTxn.TransactionIDField)
              } else {
                _root_.scala.None
              }
            case 4 =>
              if (name ne null) {
                ...
                _root_.scala.Some(ConsumerTxn.NameField)
              } else {
                _root_.scala.None
              }
   ...
   * _passthroughFields.
   */
  def setField(_blob: TFieldBlob): ConsumerTxn = {
   ...
   */
  def unsetField(_fieldId: Short): ConsumerTxn = {
    var stream: String = this.stream
    var partition: Int = this.partition
    var transactionID: Long = this.transactionID
    var name: String = this.name
   ...
   * from the passthroughFields map, if present.
   */
  def unsetStream: ConsumerTxn = unsetField(1)

  def unsetPartition: ConsumerTxn = unsetField(2)

  def unsetTransactionID: ConsumerTxn = unsetField(3)

  def unsetName: ConsumerTxn = unsetField(4)


  override def write(_oprot: TProtocol): Unit = {
    ConsumerTxn.validate(this)
  ...
  override def canEqual(other: Any): Boolean = other.isInstanceOf[ConsumerTxn]

  private def _equals(x: ConsumerTxn, y: ConsumerTxn): Boolean =
      x.productArity == y.productArity &&
      x.productIterator.sameElements(y.productIterator)

  override def equals(other: Any): Boolean =
    canEqual(other) &&
      _equals(this, other.asInstanceOf[ConsumerTxn]) &&
      _passthroughFields == other.asInstanceOf[ConsumerTxn]._passthroughFields
  ...
  override def productPrefix: String = "ConsumerTxn"

  def _codec: ThriftStructCodec3[ConsumerTxn] = ConsumerTxn
}