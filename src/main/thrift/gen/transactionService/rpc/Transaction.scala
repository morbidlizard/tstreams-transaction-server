...
object Transaction extends ThriftStructCodec3[Transaction] {
  ...
  def unapply(_item: Transaction): _root_.scala.Option[scala.Product2[Option[transactionService.rpc.ProducerTransaction], Option[transactionService.rpc.ConsumerTransaction]]] = _root_.scala.Some(_item)
...
trait Transaction
  ...
  with scala.Product2[Option[transactionService.rpc.ProducerTransaction], Option[transactionService.rpc.ConsumerTransaction]]
