...
object TransactionInfo extends ThriftStructCodec3[TransactionInfo] {
  ...
  val TransactionFieldManifest = implicitly[Manifest[transactionService.rpc.ProducerTransaction]]
  ...
  @inline private def readTransactionValue(_iprot: TProtocol): transactionService.rpc.ProducerTransaction = {
    transactionService.rpc.ProducerTransaction.decode(_iprot)
  }

  @inline private def writeTransactionField(transaction_item: transactionService.rpc.ProducerTransaction, _oprot: TProtocol): Unit = {
    _oprot.writeFieldBegin(TransactionField)
    writeTransactionValue(transaction_item, _oprot)
    _oprot.writeFieldEnd()
  }

  @inline private def writeTransactionValue(transaction_item: transactionService.rpc.ProducerTransaction, _oprot: TProtocol): Unit = {
